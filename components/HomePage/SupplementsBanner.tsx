...
const SupplementsBanner = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mx-4 sm:mx-8 lg:mx-14 my-8 sm:my-10 lg:my-14 rounded-2xl font-unbounded font-light">
      <div className="bg-[url('/images/couple-goals.jpg')] bg-cover lg:bg-[length:108%] bg-center lg:bg-[right_65%_top_30%] lg:col-span-3 h-[400px] sm:h-[450px] lg:h-[360px] w-full object-cover rounded-[18px] p-6 sm:p-8 lg:p-12 flex flex-col justify-between">
